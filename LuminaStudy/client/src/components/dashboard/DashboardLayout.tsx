...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-studio-bg selection:bg-primary/10">
      
      {/* ── DESKTOP SIDEBAR ── */}
      <aside
        className="fixed left-0 top-0 h-full z-50 hidden lg:flex flex-col border-r border-[#160E0C]/5"
        style={{
          width: sidebarW,
          background: '#160E0C',
